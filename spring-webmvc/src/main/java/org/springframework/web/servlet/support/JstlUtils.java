...
public abstract class JstlUtils {
	...
	public static void exposeLocalizationContext(RequestContext requestContext) {
		Config.set(requestContext.getRequest(), Config.FMT_LOCALE/* javax.servlet.jsp.jstl.fmt.locale */, requestContext.getLocale());
		TimeZone timeZone = requestContext.getTimeZone();
		if (timeZone != null) {
			Config.set(requestContext.getRequest(), Config.FMT_TIME_ZONE/* javax.servlet.jsp.jstl.fmt.timeZone */, timeZone);
		}
		...
		Config.set(requestContext.getRequest(), Config.FMT_LOCALIZATION_CONTEXT/* javax.servlet.jsp.jstl.fmt.localizationContext */, jstlContext);
	}
