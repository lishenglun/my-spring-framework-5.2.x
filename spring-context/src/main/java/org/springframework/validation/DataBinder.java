...
public class DataBinder implements PropertyEditorRegistry, TypeConverter {
	...
	public void registerCustomEditor(Class<?> requiredType, PropertyEditor propertyEditor) {
		// 获取对应的属性编辑器注册表(SimpleTypeConverter，也是个类型转换器)，然后注册属性编辑器。
		// SimpleTypeConverter间接继承PropertyEditorRegistrySupport、间接实现PropertyEditorRegistry；
		// 所以走的是PropertyEditorRegistrySupport，在PropertyEditorRegistrySupport里面有属性注册器集合，往里面注册对应的属性编辑器
