...
/**
 * 连接持有器，会放入到线程的本地变量中，方便后续嵌套的事务方法复用相同的连接，达到融入外层事务的作用
 *
 ...
 * {@link DataSourceTransactionManager} 将此类的实例绑定到线程，用于特定的 {@link javax.sql.DataSource}。
 *
...
public class ConnectionHolder extends ResourceHolderSupport {
	...
	public Savepoint createSavepoint() throws SQLException {
		...
		return getConnection().setSavepoint(SAVEPOINT_NAME_PREFIX/* SAVEPOINT_ */ + this.savepointCounter);
	}
