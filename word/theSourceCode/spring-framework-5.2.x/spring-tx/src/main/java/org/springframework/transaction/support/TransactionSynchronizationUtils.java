...
public abstract class TransactionSynchronizationUtils {
	...
	/**
	 * 必要时解包datasource，一般不需要解包，都是原路返回，传进来什么datasource，返回什么datasource
	 *
	...
	static Object unwrapResourceIfNecessary(Object resource) {
		...
		// unwrap infrastructure proxy —— 展开基础架构代理
		if (resourceRef instanceof InfrastructureProxy/* 基础代理类型 */) {
			resourceRef = ((InfrastructureProxy) resourceRef).getWrappedObject();
		}
		if (aopAvailable) {
			// now unwrap scoped proxy —— 现在解开范围代理
			// ⚠️
