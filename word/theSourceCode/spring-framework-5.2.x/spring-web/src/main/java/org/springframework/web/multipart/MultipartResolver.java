...
/**
 * MultipartResolver用于处理上传请求，处理方式是将普通的request包装成MultipartHttpServletRequest,这样就可以直接调用getFile方法来获取File，
 ...
 * and standalone.
 *
 * 符合<a href="https:www.ietf.orgrfcrfc1867.txt">RFC 1867<a>的分段文件上传解析策略接口。实现通常既可以在应用程序上下文中使用，也可以独立使用。
 *
...
public interface MultipartResolver {
	...
	/**
	 * 上传请求，处理完成之后，清理上传过程中产生的临时资源（清理一下我们在上传过程中，产生的一些缓存，或者说临时资源）
	 *
