...
public abstract class CommonsFileUploadSupport {
	...
	protected MultipartParsingResult parseFileItems(List<FileItem> fileItems, String encoding) {
		...
		// Extract multipart files and multipart parameters. —— 提取多部分文件和多部分参数。
		...
		// 把这3个值全部放入MultipartParsingResult中，表示我已经解析完当前请求了，里面的参数值我都已经封装好了，变成了一个MultipartParsingResult结果
		// 后续可通过MultipartParsingResult对象取出结果值
	 ...
	 *
	 * Spring MultipartFiles 的 Map 和 multipart 参数的 Map 的持有者。
	 */
