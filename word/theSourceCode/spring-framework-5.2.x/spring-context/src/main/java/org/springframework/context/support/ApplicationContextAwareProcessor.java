...
class ApplicationContextAwareProcessor implements BeanPostProcessor {
	 ...
	 *
	 * 完成EnvironmentAware、EmbeddedValueResolverAware、ResourceLoaderAware、ApplicationEventPublisherAware、MessageSourceAware、ApplicationContextAware对象的注入！
	 * @param bean
	 */
	private void invokeAwareInterfaces(Object bean) {
		// ⚠️如果bean对象实现了EnvironmentAware，那么就给这个bean注入environmentAware，那么这个bean内部就可以获取到environmentAware了！
