...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		...
		*/
		 ...
		 * ⚠️需要注意的是：实际上的扫描工作不是这个scanner对象来完成的，这个对象只是为了程序员可以显示的调用scan()方法进行使用，例如：
		 * 		AnnotationConfigApplicationContext annotationConfigApplicationContext = new AnnotationConfigApplicationContext();
		 * 		annotationConfigApplicationContext.scan("com.springstudy");
		 * 那真正的扫描工作是由哪个对象来完成呢？是Spring在ComponentScanAnnotationParser#pare()方法，第一行重新「new ClassPathBeanDefinitionScanner()」，这个对象来完成扫描的
		 */
