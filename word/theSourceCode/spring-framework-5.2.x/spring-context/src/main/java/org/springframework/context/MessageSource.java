...
/**
 * 此接口提供了处理消息的策略，包含了信息的国际化和包含参数的信息替换
 *
...
public interface MessageSource {
	 ...
	 */
	@Nullable
	String getMessage(String code/* 相当于标识符，比如说我们需要进行哪些属性的相关解析工作 */, @Nullable Object[] args, @Nullable String defaultMessage, Locale locale);
