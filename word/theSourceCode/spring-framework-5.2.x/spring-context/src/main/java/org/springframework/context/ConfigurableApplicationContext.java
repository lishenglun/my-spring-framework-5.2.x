...
public interface ConfigurableApplicationContext extends ApplicationContext, Lifecycle, Closeable {
	...
	/**
	 * Name of the ConversionService bean in the factory. - 工厂中ConversionService bean的名称。
	 * If none is supplied, default conversion rules apply. - 如果未提供，则应用默认转换规则。
	 * @since 3.0
	...
	/**
	 *
	 * environment表示我们当前系统的一些环境对象，会加载系统的【环境值】和【变量值】
	 *
