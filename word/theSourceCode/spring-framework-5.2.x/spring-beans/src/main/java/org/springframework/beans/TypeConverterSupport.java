...
public abstract class TypeConverterSupport extends PropertyEditorRegistrySupport implements TypeConverter {
	...
	public <T> T convertIfNecessary(@Nullable Object value/* 参数值 */, @Nullable Class<T> requiredType/* 参数类型 */,
		...
		return convertIfNecessary(value, requiredType,
				(methodParam != null ? new TypeDescriptor(methodParam)/* 创建方法参数对应的属性描述符 */ : TypeDescriptor.valueOf(requiredType)));
	}
	...
	@Override
	public <T> T convertIfNecessary(@Nullable Object value/* 参数值 */, @Nullable Class<T> requiredType/* 参数类型 */,
			@Nullable TypeDescriptor typeDescriptor/* 里面包含了单个方法参数 */) throws TypeMismatchException {
