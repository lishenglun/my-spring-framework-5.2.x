...
public class ReaderContext {
	...
	private final SourceExtractor sourceExtractor/* 来源提取器 */;
	...
	public void fireDefaultsRegistered(DefaultsDefinition defaultsDefinition) {
		// EmptyReaderEventListener#defaultsRegistered()
		this.eventListener.defaultsRegistered(defaultsDefinition);
	}

	/**
	 * Fire a component-registered event. —— 触发组件注册的事件
	 */
	public void fireComponentRegistered(ComponentDefinition componentDefinition) {
		// 调用监听者处理componentDefinition，实际的处理工作是，注册组件
		// EmptyReaderEventListener —— 里面什么都没干
		this.eventListener/* 事件监听者 */.componentRegistered/* 注册组件 */(componentDefinition);
	}
	...
	public Object extractSource(Object sourceCandidate) {
		// 走NullSourceExtractor，返回的是null
		return this.sourceExtractor/* 来源提取器 */.extractSource(sourceCandidate, this.resource);
	}
