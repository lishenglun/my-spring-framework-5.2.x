...
public interface BeanExpressionResolver {
	 ...
	 */
	@Nullable
	Object evaluate(@Nullable String value, BeanExpressionContext/* Bean表达式上下文 */ evalContext) throws BeansException;
