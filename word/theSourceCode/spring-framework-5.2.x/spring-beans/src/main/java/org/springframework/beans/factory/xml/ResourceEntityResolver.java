...
public class ResourceEntityResolver extends DelegatingEntityResolver {
	...
	public ResourceEntityResolver(ResourceLoader resourceLoader) {
		// ⚠️创建了dtd、xsd两种解析方式的对象
		// ⚠️schema映射的位置是在里面进行设置的，位置是"META-INF/spring.schemas"
	...
	@Override
	@Nullable
	public InputSource resolveEntity(@Nullable String publicId, @Nullable String systemId/* xsd文件的网络位置 */)
			throws SAXException, IOException {
		// ⚠super = ️DelegatingEntityResolver
		...
		if (source == null && systemId != null) {
			...
			if (resourcePath != null) {
				...
				try {
					/**
					 * ⚠️如果本地没有找到【https://www.mashibing.com/schema/user.xsd】——"xsd文件的网络位置"所对应的"本地xsd文件位置"，
					 * 那么在openStream()内部，就会去连网请求【https://www.mashibing.com/schema/user.xsd】获取对应的xsd文件，
					 * 如果没找到就会报FileNotFoundException异常！
					 */
