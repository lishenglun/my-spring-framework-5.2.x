 ...
 *
 * Simple strategy interface for resolving a String value. —— 用于解析字符串值的简单策略接口。
...
public interface StringValueResolver {
	...
	/**
	 * Resolve the given String value, for example parsing placeholders. —— 解析给定的字符串值，例如解析占位符。
	 *
