...
/**
 * 生成class为了处理多个键的组合，一起作为key，例如，1，2，3是一个组合，2，3也是一个组合，都可以作为key
 *
...
abstract public class KeyFactory {
	...
	public static KeyFactory create(ClassLoader loader, Class keyInterface, KeyFactoryCustomizer customizer,
		...
		// 创建一个最简易的"代理对象生成器"，即只会生成HashCode、equals、toString、newInstance方法
		Generator gen = new Generator();
		// 设置接口为enhancerKey类型
		gen.setInterface(keyInterface);

		// 设置Spring的上下文类型 —— 为了整合spring，在里面加了一个ContextClass
		// SPRING PATCH BEGIN
	...
	public static class Generator extends AbstractClassGenerator {
		...
		public KeyFactory create() {
			...
			setNamePrefix/* 设置名称前缀 */(keyInterface.getName());
			// ⚠️
