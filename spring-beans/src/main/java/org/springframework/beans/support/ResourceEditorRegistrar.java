...
public class ResourceEditorRegistrar implements PropertyEditorRegistrar {
	 ...
	 */
	@Override
	public void registerCustomEditors(PropertyEditorRegistry registry/* ⚠️registry = BeanWrapperImpl  */) {
	 ...
	 */
	private void doRegisterEditor(PropertyEditorRegistry registry/* ⚠️registry = BeanWrapperImpl  */, Class<?> requiredType, PropertyEditor editor) {
		// ⚠️registry = BeanWrapperImpl
		// ⚠️BeanWrapperImpl间接继承PropertyEditorRegistrySupport，所以目前只走了这里面的逻辑，下面的else{}逻辑没有走
