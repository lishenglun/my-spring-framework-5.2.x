 ...
 */
public abstract class PropertyResourceConfigurer/* 属性资源配置器 */ extends PropertiesLoaderSupport
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		try {
			...
			/* 2、转换属性 */
			// Convert the merged properties, if necessary. —— 如有必要，转换合并的属性。
			convertProperties(mergedProps);

			/* 3、访问给定bean工厂中的每个bd，并尝试用给定属性的值，替换${...}属性占位符 */
			// Let the subclass process the properties. —— 让子类处理属性。
