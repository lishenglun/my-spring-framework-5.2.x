...
public class XmlReaderContext extends ReaderContext {
	 ...
	 * @param resource the XML bean definition resource —— XML bean 定义资源
	 * @param problemReporter the problem reporter in use —— 正在使用的问题报告器
	 * @param eventListener the event listener in use —— 正在使用的事件侦听器
	 * @param sourceExtractor the source extractor in use —— 正在使用的源提取器
	 * @param reader the XML bean definition reader in use —— 正在使用的 XML bean 定义阅读器
	 * @param namespaceHandlerResolver the XML namespace resolver —— XML 命名空间解析器
	 */
	public XmlReaderContext(
		...
		this.reader = reader;
		// ⚠️DefaultNamespaceHandlerResolver
