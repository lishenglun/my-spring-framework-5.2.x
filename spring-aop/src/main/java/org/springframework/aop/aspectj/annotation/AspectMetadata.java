...
public class AspectMetadata implements Serializable {
	 ...
	 */
	// 切面名称（aspectName = beanName），例如：定义了@AspectJ注解类的名称
	...
	public AspectMetadata(Class<?> aspectClass, String aspectName) {
		...
		switch (this.ajType.getPerClause().getKind()) {
			...
			case PERTHIS:
				...
				return;
			case PERTYPEWITHIN:
				// Works with a type pattern —— 使用类型模式
	...
	/**
	 * Return whether the aspect needs to be lazily instantiated. —— 返回是否需要延迟实例化切面
	 */
