...
/**
 * 当定义在@ControllerAdvice这个类里面的方法是能够被所有Controller共享的
 *
 * 应用场景：返回统一响应、统一异常处理、统一参数初始化操作（单一的初始化参数操作是@InitBinder），往ModelAttribute里面设置属性值
 *
 ...
 *
 * {@link Component @Component} 用于声明 {@link ExceptionHandler @ExceptionHandler}、
 * {@link InitBinder @InitBinder} 或 {@link ModelAttribute @ModelAttribute} 方法的类的特殊化，
